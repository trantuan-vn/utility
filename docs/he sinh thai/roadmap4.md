...
gantt
    ...
    section ⬤ Chú giải trạng thái (Legend)
        ...
        x Quan trong (critical): crit, 2025-08-15, 7d
    ...
    section Giai đoạn 0 - Chuẩn bị hệ sinh thái (Pre-core)
        ...
        R0.7 - Xây dựng bản mô phỏng kiến trúc + mermaid diagram: r0_7, 2025-06-25, 15d
    ...
    section Giai đoạn 1 - Ví Smart Account (Core - Phase 1)
        ...
        R1.9 - Tích hợp LayerZero cho ví cross-chain: r1_9, after r1_2, 25d
    ...
    section Giai đoạn 2 - zkRollup Core Infra (Core - Phase 2)
        ...
        R2.4 - Tích hợp LayerZero + zkBridge với zkRollupVN: r2_4, after r2_2, 60d
    ...
    section Giai đoạn 3 - SDK & Devtools (Core - Phase 3)
        ...
        R3.7 - SDK hỗ trợ LayerZero + event proof handler: r3_7, after r3_2, 25d
    ...
    section Giai đoạn 5 - Sàn giao dịch Rollup-native (Tiện ích - Phase 2)
        ...
        R5.3 - Cross-rollup bridge (zkBridge + LayerZero): crit, r5_3, after r5_2, 30d
